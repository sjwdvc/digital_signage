...
<div>
    <div class="text-black">
        <section class="text-gray-600 body-font">
            <div class="max-w-7xl mx-auto flex px-5 py-12 md:py-36 md:flex-row flex-col items-center">
                <div class="md:w-1/2 md:ml-24 pt-6 flex flex-col md:items-start md:text-left mb-20 items-center text-center">
                    ...
                    <p class="mb-4 xl:w-3/4 text-gray-600 text-lg">Upload a file and optionally add a description.</p>
                    ...
                    <div class="flex justify-center">
                        <a class="inline-flex items-center px-5 py-3 mt-2 font-medium text-white transition duration-500 ease-in-out transform bg-transparent border rounded-lg bg-gray-900"
